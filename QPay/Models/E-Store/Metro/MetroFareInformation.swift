...
struct MetroFareInformation : Mappable {
    
    var fareType : String?
    var currency : String?
    var amount : Double?
    var additionalNotes : String?
    var childFareList : [MetroFareChild]?
    ...
    var _childFareList : [MetroFareChild] {
        get {
            return childFareList ?? []
        }
    }
    ...
    mutating func mapping(map: Map) {
        ...
        self.childFareList <- map["ChildFareList"]
    }
}
