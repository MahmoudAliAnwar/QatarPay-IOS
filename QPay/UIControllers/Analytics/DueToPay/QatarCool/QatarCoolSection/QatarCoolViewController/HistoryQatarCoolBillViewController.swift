//
//  HistoryQatarCoolBillViewController.swift
//  QPay
//
...
class HistoryQatarCoolBillViewController: ViewController {
...
extension HistoryQatarCoolBillViewController {
    ...
    func fetchData() {
        ...
        self.requestProxy.requestService()?.getPaymentsHistoryQatarCool(qatarCoolNumber: data, { response in
...
extension HistoryQatarCoolBillViewController: UITableViewDelegate, UITableViewDataSource {
