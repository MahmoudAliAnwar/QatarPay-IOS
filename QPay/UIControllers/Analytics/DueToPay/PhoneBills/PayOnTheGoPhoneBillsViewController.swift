...
class PayOnTheGoPhoneBillsViewController: PhoneBillsController {
    ...
    private var color: UIColor = .mRed
...
extension PayOnTheGoPhoneBillsViewController {
...
extension PayOnTheGoPhoneBillsViewController {
    ...
    @IBAction func nextAction(_ sender: UIButton) {
        ...
        if self.qidNumberTextField.text!.isEmpty {
            ...
            self.sendPaymentRequest(for: .phone,
...
extension PayOnTheGoPhoneBillsViewController: RequestsDelegate {
