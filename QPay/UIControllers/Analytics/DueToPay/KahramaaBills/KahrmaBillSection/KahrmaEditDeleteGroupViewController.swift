//
//  KahrmaEditDeleteGroupViewController.swift
//  QPay
//
...
class KahrmaEditDeleteGroupViewController: ViewController {
...
extension KahrmaEditDeleteGroupViewController {
...
extension KahrmaEditDeleteGroupViewController: UITableViewDelegate, UITableViewDataSource {
...
extension KahrmaEditDeleteGroupViewController : EditDeleteGroupTableCellDelegate {
    ...
    func didTapDeleteGroup(_ cell: EditDeleteGroupTableCell, for group: Group) {
        ...
        alert.addAction(UIAlertAction(title: "OK", style: .destructive , handler: { _ in
            ...
            self.requestProxy.requestService()?.removeKaharmaGroup(groupID: group._id, { baseResponse in
...
extension KahrmaEditDeleteGroupViewController : EditGroupNameViewControllerDelegate {
