//
//  KahrmaBillOperationsViewController.swift
//  QPay
//
...
class KahrmaBillOperationsViewController: ViewController {
...
extension KahrmaBillOperationsViewController {
...
extension KahrmaBillOperationsViewController {
    ...
    @IBAction func deleteAction(_ sender: UIButton) {
        ...
        let alert = UIAlertController.init(title: "", message: "Do you want Delete this number ?", preferredStyle: .alert)
        alert.addAction(UIAlertAction(title: "OK", style: .destructive , handler: { _ in
            
            self.showLoadingView(self)
            
            self.requestProxy.requestService()?.removeKaharmaNumber(id: data._id, { baseResponse in
                self.hideLoadingView()
    ...
    @IBAction func historyAction(_ sender: UIButton) {
        let vc    = self.getStoryboardView(HistoryKahrmaBillViewController.self)
...
extension KahrmaBillOperationsViewController: UITableViewDelegate, UITableViewDataSource {
...
extension KahrmaBillOperationsViewController : PhoneBillOperationTableViewCellDelegate {
    ...
    func didTapDelete(_ cell: PhoneBillOperationTableViewCell) {
        ...
        alert.addAction(UIAlertAction(title: "OK", style: .destructive , handler: { _ in
            ...
            self.requestProxy.requestService()?.deletePaymentRequestViaKahrmaBill(paymentRequestID: [id], { baseResponse in
                self.hideLoadingView()
...
extension KahrmaBillOperationsViewController: UpdateViewElement {
    ...
    private func setupCalendarPopup() {
        ...
        calendarPopup.okBtnClosure = { [weak self] date in
            ...
            case .editDate:
                ...
                self.requestProxy.requestService()?.updatePaymentRequestViaKaharmaBill(paymentRequestObject: object, { response in
