//
//  PayOnTheGoViewController.swift
//  QPay
//
...
class PayOnTheGoKahramaaViewController: KahramaaBillsController {
    ...
    private var color: UIColor = .mLight_Blue
...
extension PayOnTheGoKahramaaViewController {
...
extension PayOnTheGoKahramaaViewController {
    ...
    @IBAction func nextAction(_ sender: UIButton) {
        ...
        if self.qidNumberTextField.text!.isEmpty {
            ...
            self.sendPaymentRequest(for: .kahramaa,
...
extension PayOnTheGoKahramaaViewController: RequestsDelegate {
