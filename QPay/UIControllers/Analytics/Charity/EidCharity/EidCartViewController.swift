...
class EidCartViewController: CharityController {
...
extension EidCartViewController {
...
extension EidCartViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension EidCartViewController: CharityCartDetailsCollectionViewCellDelegate {
...
extension EidCartViewController: SelectAllHeaderViewDelegate {
    
    var selectAllHeaderViewDesign: SelectAllHeaderViewDesign {
        get {
            return EidCartSelectAllHeaderViewDesign()
        }
    }
...
class EidCartSelectAllHeaderViewDesign: SelectAllHeaderViewDesign {
    
    var viewColor: UIColor {
        get {
            return .mCart_Eid_Red
        }
    }
