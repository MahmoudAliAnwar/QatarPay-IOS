...
extension Date {
    ...
    public func server1DateToString(timeZone: TimeZone = TimeZone(abbreviation: "GMT")!) -> String {
        return formatDate(ServerDateFormat.Server1.rawValue)
    }
    
    public func server4DateToString(timeZone: TimeZone = TimeZone(abbreviation: "GMT")!) -> String {
        return formatDate(ServerDateFormat.Server4.rawValue)
    }
    
    public func server2DateToString(timeZone: TimeZone = TimeZone(abbreviation: "GMT")!) -> String {
        return formatDate(ServerDateFormat.Server1.rawValue)
    }
